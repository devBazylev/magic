...
function FavoritesCard({id, name, alt, price, tag, image, desc, handleAddToCart, handleFav}: CardProps & { handleAddToCart: (evt: React.MouseEvent<HTMLButtonElement>) => void; handleFav: () => void }): JSX.Element {
  ...
  return (
    <li className="favorites__item" data-id={id} data-tag={tag}>
      ...
      <div className="favorites__cont">
        ...
        <button className="btn favorites__fav favorites__fav--active" type="button" data-fav-id={id} onClick={handleFav}>
