...
function FavoritesCard({id, name, alt, price, tag, image, desc, handleAddToCart, handleFav}: CardProps & { handleAddToCart: () => void; handleFav: () => void }): JSX.Element {
    ...
    <li className="favorites__item" data-id={id} data-tag={tag}>
      ...
      <div className="favorites__cont">
        ...
        <div className="favorites__bag">
          ...
          <button className="favorites__btn btn" type="button" onClick={handleAddToCart}>
        ...
        <button className="btn favorites__fav favorites__fav--active" type="button" onClick={handleFav}>
          <svg className="favorites__heart" fill="transparent" height="200" width="200" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" aria-label="Favorite.">
