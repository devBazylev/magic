    ...
    <div className="info__case">
      ...
      <div className="info__choice">
        <label className="info__label btn">
          <input className="visually-hidden info__check" type="checkbox" name="Magic items" id="mi" tabIndex={-1} /><span className="info__backup" tabIndex={1} /><span className="info__checktext">Magic&nbsp;items</span>
        </label>
        <label className="info__label btn">
